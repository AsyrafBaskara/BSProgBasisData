...
<body class="bgimg" style="background-image: url('https://c.tenor.com/A4JsT9Pp_BoAAAAC/pulpfiction-miawallace.gif');">
    ...
    <div style="margin-top:10%;">
        <a href="tambahartinfo.php">
            <p>Tambah?</p>
        </a>
        <form action="" method="post" style="margin-bottom:0%;">
            <input type="text" name="keyword" size="40" autofocus placeholder="masukkan kata kunci untuk pencarian"
        ...
        <div id="container">
            <table
                style="background-image: url('https://i.pinimg.com/originals/81/32/96/813296022908d0d4adaa55a4eaf5207a.gif');color:white;"
                ...
                <tr>
                    ...
                    <td><a href="hapus1.php?id=<?= $row["id_foto"]?>" onclick="return confirm('Yakin?');"
                            style="color:white;">Hapus</a></td>
                </tr>
                <?php $i++ ?>
                <?php endforeach; ?>
            </table>

...
if(isset($_POST['enter'])){
    if(transactionadd($_POST)){
      echo"<script>alert('New Trashsaction Made');</script>";
    } else {
      echo"<script>alert('Trashsaction Failed');</script>";
    }
...
<head>
  ...
  <title>Bank Sampah | Trashsaction</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="trashsaction.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Trashsaction</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TrashSaction's Forms</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">TrashSaction</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="login">
              <form method="post" action="" autocomplete="off" class="formbox">
                <input type="hidden" name="tman_id" value="<?=$_SESSION["idlog"]?>"/>
                <b><span class="spanform">Trash</span></b>
                <input type="text" class="text" name="trashname">
                <b><span class="spanform">Trasher Name</span></b>
                <input type="text" class="text" name="trashername">
                <b><span class="spanform">Date & Time</span></b><br>
                <input type="datetime-local"name="datentime" class="text">
                <b><span class="spanform">Weight</span></b><br>
                <input type="number" class="text" name="weight" min="0" step="1" max="1000" value="0" /><b style="display:inline-block">Kg</b>
                <br/>
                <b><span class="spanform">Description</span></b><br>
                <input type="text" class="text" name="descr">

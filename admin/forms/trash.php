...
if(isset($_POST['enter'])){
    if(plustype($_POST)){
      echo"<script>alert('New Trash Made');</script>";
    } else {
      echo"<script>alert('Trash Making Failed');</script>";
    }
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="trashman.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>TrashMan (<em>owner only</em>)</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="trasher.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Trasher</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="trashsaction.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Trashsaction</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="trash.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Trash</p>
                </a>
              </li>
        ...
        <div class="login">
            ...
            ?>
              <form method="post" action="" autocomplete="off" class="formbox">
                ...
                <option selected="true" disabled="disabled">--Choose The Type--</option>
                  <?php
                ...
                <b style="display:inline-block">Rp</b><input type="number" class="text" name="price" min="1000" step="1000" max="1000000" value="1000" />

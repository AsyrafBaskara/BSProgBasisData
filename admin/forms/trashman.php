...
if(isset($_POST['enter'])){
    if(register($_POST)){
      echo"<script>alert('New TrashMan Made');</script>";
    } else {
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="trashman.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">TrashMan's Forms</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Trashman</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            if(isset($_SESSION['error'])){ ?>
                            ...
                            <?php }
            ?>
                            <h5 class="inform"><em>"Hanya owner yang dapat memasukkan Trashman"</em></h5>
                            <form method="post" action="" autocomplete="off" class="formbox">
                                ...
                                <b><span class="spanform">Password</span></b>

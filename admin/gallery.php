...
<head>
    ...
    <title>Bank Sampah | Gallery</title>
...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="dist/img/AdminAKUSAMPAHLogo.png" alt="AdminLTELogo" height="60"
                width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="dist/img/AdminAKUSAMPAHLogo.png" alt="AdminLTE Logo"
                                    ...
                                    <div>
                                        <div class="btn-group w-100 mb-2">
                                            <a class="btn btn-info active" href="javascript:void(0)" data-filter="all">
                                                All items </a>
                                            <a class="btn btn-info" href="javascript:void(0)" data-filter="1"> Trash
                                            </a>
                                            <a class="btn btn-info" href="javascript:void(0)" data-filter="2"> TrashMan
                                            </a>
                                            <a class="btn btn-info" href="javascript:void(0)" data-filter="3"> Others
                                            </a>
                                        ...
                                        <div class="filter-container p-0 row">
                                            <div class="filtr-item col-sm-2" data-category="1">
                                                <a href="gallery/trash1.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trash1.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="1">
                                                <a href="gallery/trash2.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trash2.jpg" class="img-fluid mb-2  thumbimg"
                                                        alt="black sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="1">
                                                <a href="gallery/trash3.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trash3.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="red sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="1">
                                                <a href="gallery/trash5.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trash5.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="red sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="1">
                                                <a href="gallery/trash4.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trash4.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="red sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2">
                                                <a href="gallery/trashman1.png" data-toggle="lightbox">
                                                    <img src="gallery/trashman1.png" class="img-fluid mb-2 thumbimg"
                                                        alt="black sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2">
                                                <a href="gallery/trashman2.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trashman2.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2">
                                                <a href="gallery/trashman3.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trashman3.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2">
                                                <a href="gallery/trashman4.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trashman4.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="black sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="2">
                                                <a href="gallery/trashman5.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trashman5.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="red sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="3">
                                                <a href="gallery/trasher1.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trasher1.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="3">
                                                <a href="gallery/trasher2.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trasher2.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="white sample" />
                                                </a>
                                            </div>
                                            <div class="filtr-item col-sm-2" data-category="3">
                                                <a href="gallery/trasher3.jpg" data-toggle="lightbox">
                                                    <img src="gallery/trasher3.jpg" class="img-fluid mb-2 thumbimg"
                                                        alt="black sample" />
                                                </a>
                                            </div>
                                        </div>

...
<style>
body {
    background: url(../others/mountaingifforbg.gif) no-repeat center center fixed;
     overflow: hidden;
     position: relative;
     height: 100%;
...
<h2 class="nonactive" href="reg.php" onclick="location.href='login.php'"> Sign In </h2>
...
?>
  ...
  <input type="name" style="color:gray;" class="text" name="name">
     <b><span>Name</span></b>
    <br>
    <br>
